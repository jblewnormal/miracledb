...
export function MiracleItem({ miracle, detailsHref, sx, ...other }: PostItemProps) {
  return (
    <Card sx={sx} {...other}>
      <Box sx={{ position: 'relative' }}>
        ...
        <Image alt={miracle.title} src={miracle.coverUrl} ratio="4/3" />
      </Box>
      ...
      <CardContent sx={{ pt: 6 }}>
        ...
        <InfoBlock
          totalViews={miracle.totalViews}
          totalShares={miracle.totalShares}
          totalComments={miracle.totalComments}
        />
      </CardContent>
    </Card>
  );
