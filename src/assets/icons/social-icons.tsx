...
export const FacebookIcon = forwardRef<SVGSVGElement, SvgIconProps>((props, ref) => {
  const { sx, ...other } = props;
...
export const TwitterIcon = forwardRef<SVGSVGElement, SvgIconProps>((props, ref) => {
  const { sx, ...other } = props;
...
export const GoogleIcon = forwardRef<SVGSVGElement, SvgIconProps>((props, ref) => {
  const { sx, ...other } = props;
...
export const InstagramIcon = forwardRef<SVGSVGElement, SvgIconProps>((props, ref) => {
  const { sx, ...other } = props;
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset="1" stopColor="var(--color, #D800B9)" />
        </linearGradient>
        <linearGradient
          id={`${gradientId}-2`}
          x1="4.57544"
        ...
        >
          ...
          <stop offset="0.5" stopColor="var(--color, #FF0100)" />
          <stop offset="1" stopColor="var(--color, #FD0056)" />
        </linearGradient>
        <linearGradient
          id={`${gradientId}-3`}
          x1="16.7139"
